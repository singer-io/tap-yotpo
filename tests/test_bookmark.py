...
class YotpoBookMarkTest(YotpoBaseTest):
    ...
    def test_run(self):
        ...
        expected_streams = self.expected_sync_streams() - {"product_variants"}
                ...
                if expected_replication_method == self.INCREMENTAL:
                    ...
                    if stream in ["product_reviews", "order_fulfillments", "product_variants"]:
                        ...
                        for record in second_sync_messages:
                            try:
                                replication_key_value = record.get(replication_key)
                                simulated_bookmark_minus_lookback_value = simulated_bookmark_minus_lookback[
                                ...
                                second_bookmark_value_utc_value = second_bookmark_value_utc[
                                    record[bookmark_keys[stream]]
                                ]
